...
##
model_2021_GI<-data.frame(year=rep("2021",8),trait=c(rep("GI",6),rep("GI_base",2)),PM_date=c(5,22,19,33,47,68,96,152),Q=rep("yes",8),npc=rep("2",8),Fixed=c(NA,NA,NA,"replication",NA,"Location","Location:Row + replication","Location"),Random=rep(NA,8),Residual=c("Location",NA,"replication",NA,NA,NA,"Row",NA),Converged=c("yes","yes","yes","yes","yes","yes","yes","yes"))
...
#manhattan
```{r}
load("~/git/BarleyGermination-KK/data/GWA_results/STP_all.Rdata")

markerpart<-STP_all[STP_all$ID%in%c("GE-2020-PM_152","GE-2020-PM_19","GE-2020-PM_47","GE-2020-PM_5","GE-2020-PM_96"),]$marker%>%unique()
markerall<-STP_all[!STP_all$ID%in%c("GE-2020-PM_152","GE-2020-PM_19","GE-2020-PM_47","GE-2020-PM_5","GE-2020-PM_96"),]$marker%>%unique()
STP_smal<-STP_all[STP_all$ID%in%c("GE-2020-PM_152","GE-2020-PM_19","GE-2020-PM_47","GE-2020-PM_5","GE-2020-PM_96"),]
mb<-STP_smal$marker%>%unique()

STP_smal[!STP_smal$marker%in%(markerall),]
which(markerall==mb)
...
ALaAT_ord
ALaAT_ord<-ALaAT_ord[4]
max(WinterPerTPGWAS2$ordinal,na.rm = TRUE)
