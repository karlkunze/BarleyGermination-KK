...
#REFERENCE 3
AlaT_markers_1<-AlaT_markers_1%>%as.data.frame%>%tibble::add_column("rs#"="Qsd1","alleles"="G/C","chrom"="5H","pos"=435636564,"strand"="+",.before =1)
...
wmb_gt[wmb_gt$`rs#`=="Qsd1",]$alleles<-"G/C"
...
wmb_num<-wmbGAPIT
wmb_num$GD[wmb_num$GD$Qsd1==1,]$Qsd1<-0
...
snpset <- snpgdsLDpruning(gdsfile, ld.threshold=0.95,method="corr",slide.max.bp = 25000,maf = 0.05,remove.monosnp = TRUE)
