...
wdhscald.lm=lm(Scald~Entry+Location,data=WDH20_phenoF)
anova(wdhscald.lm)
WDH20_pheno$Check
wdh_wh.lm=lm(wh_percent~Entry+Location+Check+HD+Ht,data=WDH20_phenoF)
anova(wdh_wh.lm)
...
#heading data
WDH20_phenoF$HD
WDH20_phenoF_HD.lmer=lmer(HD~Location+(1|Entry),data=WDH20_phenoF)
