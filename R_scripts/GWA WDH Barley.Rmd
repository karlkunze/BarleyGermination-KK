...
AlaT_markers[AlaT_markers$Entry=="Flavia",]$Entry<-"Check 1-Flavia"
AlaT_markers[AlaT_markers$Entry=="Scala",]$Entry<-"Check 2-Scala"
AlaT_markers[AlaT_markers$Entry=="DH130910",]$Entry<-"Check 3-DH130910"
AlaT_markers[AlaT_markers$Entry=="Tepee",]$Entry<-"Check 4-SY Tepee"
AlaT_markers[AlaT_markers$Entry=="Wintmalt",]$Entry<-"Check 5-Wintmalt"


WDH20_pheno<-merge(All_pheno_TPall,AlaT_markers[,c(4,12)],by="Entry",all = T)
