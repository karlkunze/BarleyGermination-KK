...
GWAS.GETP2.blues.mlmm  =GAPIT(Y= TP2.test[,c('taxa','GE')], GD=myGD20,CV=TP2.test[,c('taxa','Qsd1')], GM=myGM20, PCA.total=2,file.output=T, Geno.View.output=T, model="MLMM", Major.allele.zero = F)
