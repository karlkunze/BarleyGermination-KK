...
wdhscald.lmer=lmer(Scald~Location+(1|Entry),data=WDH20_phenoF)
...
# GETP1
getwd()
local<-"C:/Users/Karl/Google Drive/Grad School_/Field 2020/Germination_assays/GAPIT"
setwd(local)
getwd()



GWAS.GITP4.blues.mlm  =GAPIT(Y= GITP4.blues, GD=myGD20, GM=myGM20, PCA.total=2,file.output=T, Geno.View.output=T, model="MLM", Major.allele.zero = F)
...
GWAS.GITP4.blues_5D.mlm  =GAPIT(Y= GITP4_5D.blues, GD=myGD20, GM=myGM20, PCA.total=2,file.output=T, Geno.View.output=T, model="MLM", Major.allele.zero = F)


GWAS.GITP4.blues_5D.mlmm =GAPIT(Y= GITP4_5D.blues, GD=myGD20, GM=myGM20, PCA.total=2,file.output=T, Geno.View.output=T, model="MLMM", Major.allele.zero = F)
...
GWAS.GITP3.blups.mlm  =GAPIT(Y= GITP3.blups, GD=myGD20, GM=myGM20, PCA.total=2,file.output=T, Geno.View.output=T, model="MLM", Major.allele.zero = F)
