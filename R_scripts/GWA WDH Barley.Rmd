...
GWAS.GITP1.blups.mlmm  =GAPIT(Y= TP1_WDH20_BLUP_all[,c('taxa','GI')], GD=myGD20, GM=myGM20, PCA.total=2,file.output=T, Geno.View.output=T, model="MLMM", Major.allele.zero = F)

GWAS.GITP1_5D.blups.mlmm  =GAPIT(Y= TP1_WDH20_BLUP_all[,c('taxa','GI_5D')], GD=myGD20, GM=myGM20, PCA.total=2,file.output=T, Geno.View.output=T, model="MLMM", Major.allele.zero = F)
...
GWAS.GITP2_5D.blues.mlmm  =GAPIT(Y= TP2_WDH20_BLUE_all[,c('taxa','GI_5D')], GD=myGD20, GM=myGM20, PCA.total=2,file.output=T, Geno.View.output=T, model="MLMM", Major.allele.zero = F)
##BLUPS
...
GWAS.GITP2.blups.mlmm =GAPIT(Y= TP2_WDH20_BLUP_all[,c('taxa','GI')], GD=myGD20, GM=myGM20, PCA.total=2,file.output=T, Geno.View.output=T, model="MLMM", Major.allele.zero = F)#5H and 1H
GWAS.GITP2_5D.blups.mlmm  =GAPIT(Y= TP2_WDH20_BLUP_all[,c('taxa','GI_5D')], GD=myGD20, GM=myGM20, PCA.total=2,file.output=T, Geno.View.output=T, model="MLMM", Major.allele.zero = F) 
