...
Pval(GWAS.GETP4.blups_5D.mlmm$GWAS)
GWAS.GETP4.blups_5D.mlmm$GWAS
...
GWAS.sign.blups<-rbind(GE.TP4.blups,GI.TP4.blups,GI_5D.TP4.blups)
...
wh.blues<-Pval_Field(GWAS.wh.blues.mlmm)
...
save(Field_sign,file="data/GWAS.Field.hitsField.Rdata")
write.csv(GWAS.sign.TP_all,"data/GWAS.TP.hits22.csv")
write.csv(Field_sign,"data/GWAS.Field.hits22.csv")
