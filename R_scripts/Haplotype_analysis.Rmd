...
ld_heatmap(myGD20[,c(4502:4503)]) + ggtitle('LD between significant marker regions at 5H') +
  theme(axis.text.x = element_text(angle = 90))+
  

  scale_x_discrete(label = c("Qsd1","JHI-Hv50k-2016-308652"), breaks = c("Qsd1"))+
  scale_y_discrete(label = c("Qsd1","JHI-Hv50k-2016-308652"), breaks = c("Qsd1","JHI-Hv50k-2016-308652"))+ 
  xlab(NULL)+ylab(NULL)
