...
TP1_WDH20_BLUE_all$Pedigree<-TP_all_WDH20_BLUE_all$Pedigree[match(TP1_WDH20_BLUE_all$taxa,All_pheno_TPall$Entry)]

TP2_WDH20_BLUE_all
All_pheno_TPall$Pedigree
TP1_WDH20_BLUE_all$Pedigree
All_pheno_TPall[All_pheno_TPall$Pedigree]



TP1_WDH20_BLUE_all$Pedigree<-All_pheno_TPall$Pedigree[match(TP1_WDH20_BLUE_all$taxa,All_pheno_TPall$Entry)]
TP2_WDH20_BLUE_all$Pedigree<-All_pheno_TPall$Pedigree[match(TP2_WDH20_BLUE_all$taxa,All_pheno_TPall$Entry)]

TP3_WDH20_BLUE_all$Pedigree<-All_pheno_TPall$Pedigree[match(TP3_WDH20_BLUE_all$taxa,All_pheno_TPall$Entry)]
TP4_WDH20_BLUE_all$Pedigree<-All_pheno_TPall$Pedigree[match(TP4_WDH20_BLUE_all$taxa,All_pheno_TPall$Entry)]

TP5_WDH20_BLUE_all$Pedigree<-All_pheno_TPall$Pedigree[match(TP5_WDH20_BLUE_all$taxa,All_pheno_TPall$Entry)]

TP_WDH20_BLUE_all<-rbind(TP1_WDH20_BLUE_all,TP2_WDH20_BLUE_all,TP3_WDH20_BLUE_all,TP4_WDH20_BLUE_all,TP5_WDH20_BLUE_all)
```
box plots
```{r}
TP_all_melt=melt(TP_WDH20_BLUE_all, id.vars =c("taxa","TP","Pedigree"), measure.vars = c("GE"))
...
TP_all_melt_GE=melt(TP_WDH20_BLUE_all, id.vars =c("taxa","TP","Pedigree"), measure.vars = c("GE"))
ggplot(data=TP_all_melt_GE, aes(x=TP, y=value,color=Pedigree)) +
  geom_boxplot()+
...
TP_all_melt_GI=melt(TP_WDH20_BLUE_all, id.vars =c("taxa","TP","Pedigree"), measure.vars = c("GIscale"))
