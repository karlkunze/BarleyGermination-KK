...
vec<-which(Field_WDH21_BLUE_part$taxa%in%TP_all_WDH20_BLUE_all[TP_all_WDH20_BLUE_all$TP=="TP1",]$taxa)
Sub=Field_WDH21_BLUE_part[vec,]

vec<-which(Field_WDH20_BLUE_all$taxa%in%TP_all_WDH20_BLUE_all[TP_all_WDH20_BLUE_all$TP=="TP1",]$taxa)
Sub1=Field_WDH20_BLUE_all[vec,]
Sub1
Sub1
hist(Sub$HD)
...
q1=Sub('Flavia','GIscale',ylim(-7.5,1),0,10)
q2=Sub('Scala','GIscale',ylim(-7.5,1),0,0)
q3=Sub('SY Tepee','GIscale',ylim(-7.5,1),10,10)
q4=Sub('Wintmalt','GIscale',ylim(-7.5,1),10,0)
