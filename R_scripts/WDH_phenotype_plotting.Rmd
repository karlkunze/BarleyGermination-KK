...
legend<-Sub_legend('Flavia','GIscale')
plot(legend)
Sub_legend<-function(c,trait){
...
Scala_df=Sub('Scala','GIscale')
SY_Tepee_df=Sub('SY Tepee','GIscale')
Wintmalt_df=Sub('Wintmalt','GIscale')
