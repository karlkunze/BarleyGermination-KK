...
names(GI21_sig)
sig<-rbind(GE20_sig,GE21_sig,GE_sig,GI20_sig,GI21_sig,GI20_sig,GWAS_phs$gwas.sel)%>%rename(ID=trait)%>%filter(!ID%in%c("GE-2021-PM_96: did_not_converge"))
sig
...
LDheatmap(gdat0,genetic.distances=gmt$Position,color=rgb.palette(18),title="LD on CH 5",SNP.name = c(gmt$SNP),add.map = TRUE,text=TRUE)
CH5_LD_groupBQsd1_real=data.frame(SNP=gmt$SNP,Ch="5",group="B_Qsd1",Position=gmt$Position,ld=0.98)
## Group C
gdt0<-gdt[,c(40:45,47:80)]
...
marker_table2[marker_table2$SNP=="JHI_Hv50k_2016_141424",]$Gene_candidate<-"Dimeric alpha-amylase inhibitor(HORVU.MOREX.r2.2HG0176960)"
...
marker_table2[marker_table2$Chr=="4",]
marker_table2[marker_table2$SNP=="JHI_Hv50k_2016_262688, JHI_Hv50k_2016_262688, JHI_Hv50k_2016_262937",]$Gene_candidate<-"	
QGpc.StMo-4H(Protein Content)"
...
marker_table2[marker_table2$SNP=="Qsd1, JHI_Hv50k_2016_308790, JHI_Hv50k_2016_308899",]$Gene_candidate<-"HvAlaAT, abscisic aldehyde oxidase 3(HORVU.MOREX.r2.5HG0399320)"

marker_table2[marker_table2$SNP=="JHI_Hv50k_2016_310470, JHI_Hv50k_2016_312196, JHI_Hv50k_2016_312374",]$Gene_candidate<-c("1,4-alpha-glucan branching enzyme GlgB(HORVU.MOREX.r2.5HG0404420), GRAM-containing/ABA-responsive protein(HORVU.MOREX.r2.5HG0404090)")
