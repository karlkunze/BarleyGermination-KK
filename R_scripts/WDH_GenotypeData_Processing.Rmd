...
ggplot(test, aes(x=X1, y=X2, color=pedigree,shape=Check))+
  geom_point(size=2) +
  theme_bw() +
...
ld_heatmap=function(df){
  ...
  graphic = ggplot(r_2, aes(Var2, Var1, fill = value))+
    ...
    theme_void() #+    ggtitle(paste("LD r2 from",colnames(r2)[1],"-", colnames(r2)[length(colnames(r2))], sep=" " ))
  return(graphic)
}
...
ld_heatmap(myGD20[,500:600])
#SD1 and SD2
ld_heatmap(myGD[,c(10780:10800, 13000:13075)])

ld_heatmap(myGD20[,c(12990:13010,13050:13075)]) + ggtitle('LD between GA20Ox and MKK3 markers') +
  scale_x_discrete(label = c('GA20Ox','MKK3'), breaks = c('SCRI_RS_121526','JHI-Hv50k-2016-367253'))+
  scale_y_discrete(label = c('GA20Ox','MKK3'), breaks = c('SCRI_RS_121526','JHI-Hv50k-2016-367253'))+ 
  xlab(NULL)+ylab(NULL)
