...
ggs=add_column(ggs, Qsd1_19$HvQsd1[match( rownames(ggs), Qsd1_19$Entry )], .after = "JHI-Hv50k-2016-308584"); colnames(ggs)[19453]='Qsd1'
...
rownames(v2)[26096]#find the position for the springs
#Qsd1 5H position "4421600" JHI-Hv50k-2016-367342


v2$SNP
v2[v2$SNP=="JHI-Hv50k-2016-367342",] #18541, #31140

hist(v2_5H$pos)
v2[v2$Order>18538 & v2$Order <18544,]
v2$SNP
v2[1:3,1:3]
v2[c(26096),c(9)]
v2[c(26097),c(4,9)]
...
which(v2[c(26096:c(26096+16)),9] %in% colnames(wdh))#17 above

v2[c(26096,26096+133),c(9)]
...
snpset <- snpgdsLDpruning(gdsfile, method="corr", ld.threshold=0.95, slide.max.bp = 25000)
