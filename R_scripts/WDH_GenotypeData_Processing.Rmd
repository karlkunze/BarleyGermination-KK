...
which(v2[c((Qsd_number+1):c(Qsd_number+10)),9] %in% colnames(wdh))#3,16 above 26098
which(v2[c((Qsd_number-11):c(Qsd_number-1)),9] %in% colnames(wdh))#13 below 26098
...
AlaT_markers[AlaT_markers$AlaT_Allele=="Tepee",]<-"SY Tepee"
...
snpset <- snpgdsLDpruning(gdsfile, method="corr", ld.threshold=0.95, slide.max.bp = 1000)
