...
colnames(wdh)[c(14,500,501)]<-c("Flavia","Scala","SY Tepee")
colnames(wdh)[c(12,13,495,498,499,502)]
#removing these acessions for this dataset
wdh<-wdh[,-c(12,13,495,498,499,502)]
#remame 
...
```{r}
wdh[1:8,1:8]
as.data.frame(t(wdh))[1:10,1:10]
colnames(wdh)[1]<-"Marker"
colnames(wdh)[1]
