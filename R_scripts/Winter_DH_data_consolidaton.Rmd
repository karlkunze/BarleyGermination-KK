...
#rbind the different timepoints, arrange by plot, rep, timepoint and add the GE/GI calculations
TP2020=rbind(TP1_half,TP2,TP3,TP4,TP5)%>%arrange(PLOT,replication,TP)%>%mutate(Location=replace(Location,str_detect(Location,"Ketola"),values="Ketola2020"),Location=replace(Location,str_detect(Location,"Snyder"),"Snyder2020"))%>%
