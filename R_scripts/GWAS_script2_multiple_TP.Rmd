...
#marker effects
library(dplyr)
marker_ef<-dim%>%as.data.frame()%>%select(c("Qsd1","JHI_Hv50k_2016_308762"))#%>%tibble::rownames_to_column()%>%dplyr::rename(GID=rowname)%>%mutate(Qsd1=as.factor(Qsd1),JHI_Hv50k_2016_308762=as.factor(JHI_Hv50k_2016_308762))
marker_ef
