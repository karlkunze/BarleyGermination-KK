...
##
length(GE_TP1_2020_model_Train$u)
GE_TP1_2020_predValues$taxa
GE_TP1_2020$taxa
dim(GE_TP1_2020_predValues)
dim(GE_TP1_2020)
dim(GE_TP1_2020_model_Train$u)
dim(GE_TP1_2020_model_Train$beta)
rownames(GE_TP1_2020_predValues)
table(GE_TP1_2020$taxa)
v<-WinterGD %>% filter(taxa %nin% GE_TP1_2020$taxa) 
rownames(v)
GE_TP1_2020[GE_TP1_2020$taxa=="WINTMALT"]
...
```{r}
library(dplyr)
simple<-DH2020_GE.logfits %>% filter(!(year=='2020' & taxa %in% TaxaToFilter2020GE$taxa)) %>%
 dplyr::rename(value = estimate,GID=taxa)%>%filter(year=="2020",term=="Centering")
