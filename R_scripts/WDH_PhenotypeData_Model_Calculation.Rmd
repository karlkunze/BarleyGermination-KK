...
setwd(dir1)
getwd()
load("data/Winter_DH/WMB DH 2020 all data for analysis.RData")
load("data/Genotype_data/myGD20.Rdata")
...
All_pheno_TPall[All_pheno_TPall$Entry=="Check 6-Charles",]$Entry
All_pheno_TPall[All_pheno_TPall$Entry=="Check 6-Charles",]$Entry<-"Charles"
All_pheno_TPall[All_pheno_TPall$Entry=="Check 8-Endeavor",]$Entry<-"Endeavor"

WDH20_pheno<-All_pheno_TPall[All_pheno_TPall$Year=="2020",]
WDH21_pheno<-All_pheno_TPall[All_pheno_TPall$Year=="2021",]
str(WDH20_pheno)
...
WDH20_pheno[WDH20_pheno$PLOT==11023,]#checking to see if the a{1}1023 lines were retained
...
wdh_mass.lm=lm(mass~Entry+Location,data=WDH20_phenoF)
anova(wdh_mass.lm)
summary(wdh_mass.lm)
```
2021 data
...
wdh21_HD.lm=lm(HD~Entry+Location,data=WDH21_pheno)
anova(wdh21_HD.lm)
WDH21_pheno.M=WDH21_pheno[WDH21_pheno$Location=="McGowan",]
wdh21_fd.lm=lm(HD~Entry+Check+frost_damage,data=WDH21_pheno.M)
anova(wdh21_fd.lm)
wdh21_scald.lm=lm(Scald~Entry+Location+Check,data=WDH21_pheno)
wdh21_SB.lm=lm(SB~Entry+Check,data=WDH21_pheno)
anova(wdh21_SB.lm)
wdh21_HD.lm
wdh21_fd.lm
wdh21_scald.lm
...
#Post Maturity days for Germination: 5,19,47,96,152
#Dates plated for Timepoints: 9/6/2020,9/22/2020,10/20/2020,12/08/2020,2/01/2020
BLUE_summary=function(mods,model,PM,TP,date){
...
#Germination
TP1_WDH20_BLUE_all=BLUE_summary(list(wdhge1.lm,wdhge1_5D.lm,wdhgi1.lm,wdhgi1_5D.lm),model="BLUE",PM="5",TP="TP1",date = "9/06/2020")
TP2_WDH20_BLUE_all=BLUE_summary(list(wdhge2.lm,wdhge2_5D.lm,wdhgi2.lm,wdhgi2_5D.lm),model="BLUE",PM="19",TP="TP2",date = "9/22/2020")
TP3_WDH20_BLUE_all=BLUE_summary(list(wdhge3.lm,wdhge3_5D.lm,wdhgi3.lm,wdhgi3_5D.lm),model="BLUE",PM="47",TP="TP3",date = "10/20/2020")
TP4_WDH20_BLUE_all=BLUE_summary(list(wdhge4.lm,wdhge4_5D.lm,wdhgi4.lm,wdhgi4_5D.lm),model="BLUE",PM="96",TP="TP4",date = "12/08/2020")
TP5_WDH20_BLUE_all=BLUE_summary(list(wdhge5.lm,wdhge5_5D.lm,wdhgi5.lm,wdhgi5_5D.lm),model="BLUE",PM="152",TP="TP5",date = "02/01/2021")
#Field
BLUE_summary_F=function(mods,model,trait_list,year){

  l=list(get_entry_fixed_Effects(mods[[1]], trait_list[1]),get_entry_fixed_Effects(mods[[2]], trait_list[2]),
         get_entry_fixed_Effects(mods[[3]], trait_list[3]),get_entry_fixed_Effects(mods[[4]], trait_list[4]),get_entry_fixed_Effects(mods[[5]], trait_list[5]),get_entry_fixed_Effects(mods[[6]], trait_list[6]),get_entry_fixed_Effects(mods[[7]], trait_list[7]))
  ...
  TP_summary=TP_summary[-c(which(!TP_summary$taxa %in% myGD20$taxa)),]
  TP_summary$model=model 
  TP_summary$year=year
  TP_summary
}
modsE<-list(WDH20phs.lm,wdh_scald.lm,wdh_wh.lm,wdh_HD.lm,wdh_Ht.lm,wdh_PM.lm,wdh_mass.lm)
trait_listE<-c("PHS","scald","wh","HD","Ht","PM","Seed_weight")
Field_WDH20_BLUE_all<-BLUE_summary_F(modsE,trait_listE,model="BLUE","2020")
Field_WDH20_BLUE_all
#2021 so far
BLUE_summary_F21=function(mods,model,trait_list,year){

  l=list(get_entry_fixed_Effects(mods[[1]], trait_list[1]),get_entry_fixed_Effects(mods[[2]], trait_list[2]),
         get_entry_fixed_Effects(mods[[3]], trait_list[3]),get_entry_fixed_Effects(mods[[4]], trait_list[4]))
...
modsE21<-list(wdh21_HD.lm,wdh21_fd.lm,wdh21_scald.lm,wdh21_SB.lm)
trait_listE21<-c("HD","frost_damage","Scald","SB")
Field_WDH21_BLUE_part<-BLUE_summary_F21(modsE21,trait_listE21,model="BLUE","2021")
Field_WDH20_BLUE_all
...
save(Field_WDH20_BLUE_all,file="data/Winter_DH/Field_WDH20_BLUE_all.Rdata")
save(Field_WDH21_BLUE_part,file="data/Winter_DH/Field_WDH21_BLUE_part.Rdata")
```

BLUPS
```{r}
library(lme4)
##BLUPS base mixed model for each trait for genotypic BLUPs
...
```{r}
#phs
wdh_phs.lmer=lmer(phs~1+(1|Entry), data=WDH20_pheno)
summary(wdhphs.lmer)
#scald
...
wdh_PM.lmer=lmer(PM~(1|Entry)+Location,data=WDH20_phenoF)
summary(wdh_PM.lmer)
AIC(wdh_PM.lmer)
anova(wdh_PM.lmer)
...
BLUP_summary=function(mods,Model,PM,TP,date){

  l=list(gapit_blup(mods[[1]], 'GE'),gapit_blup(mods[[2]], 'GE_5D'),
         gapit_blup(mods[[3]], 'GIscale'),gapit_blup(mods[[4]], 'GIscale_5D'))
...
#TP1
mods<-list(wdhGE_TP1.lmer,wdhGE_TP1_5D.lmer,wdhGI_TP1.lmer,wdhGI_TP1_5D.lmer)
TP1_WDH20_BLUP_all=BLUP_summary(mods,"BLUP","5","TP1","9/6/2020")
#TP2
mods2<-list(wdhGE_TP2.lmer,wdhGE_TP2_5D.lmer,wdhGI_TP2.lmer,wdhGI_TP2_5D.lmer)
TP2_WDH20_BLUP_all=BLUP_summary(mods2,"BLUP","19","TP2","9/22/2020")
#TP3
mods3<-list(wdhGE_TP3.lmer,wdhGE_TP3_5D.lmer,wdhGI_TP3.lmer,wdhGI_TP3_5D.lmer)
TP3_WDH20_BLUP_all=BLUP_summary(mods3,"BLUP","47","TP3","10/20/2020")
#TP4
mods4<-list(wdhGE_TP4.lmer,wdhGE_TP4_5D.lmer,wdhGI_TP4.lmer,wdhGI_TP4_5D.lmer)
TP4_WDH20_BLUP_all=BLUP_summary(mods4,"BLUP","96","TP4","12/08/2020")
#TP5
mods5<-list(wdhGE_TP5.lmer,wdhGE_TP5_5D.lmer,wdhGI_TP5.lmer,wdhGI_TP5_5D.lmer)
TP5_WDH20_BLUP_all=BLUP_summary(mods5,"BLUP","152","TP5","2/1/2021")
#Field
modsP<-list(wdh_phs.lmer,wdh_scald.lmer,wdh_wh.lmer,wdh_HD.lmer,wdh_Ht.lmer,wdh_PM.lmer)
BLUP_summary_F=function(mods,trait_list,model,year){



  l=list(gapit_blup(mods[[1]], trait_list[1]),gapit_blup(mods[[2]], trait_list[2]),
         gapit_blup(mods[[3]], trait_list[3]),gapit_blup(mods[[4]], trait_list[4]),gapit_blup(mods[[5]], trait_list[5]),gapit_blup(mods[[6]], trait_list[6]))
...
trait_listP<-c("PHS","scald","wh","HD","Ht","PM")
Field_WDH20_BLUP_all=BLUP_summary_F(modsP,trait_listP,model="BLUP",year = "2020")
#save Rdata files
save(TP1_WDH20_BLUP_all, file="data/Winter_DH/TP1_WDH20_BLUP_all.RData")
save(TP2_WDH20_BLUP_all, file="data/Winter_DH/TP2_WDH20_BLUP_all.RData")
save(TP3_WDH20_BLUP_all, file="data/Winter_DH/TP3_WDH20_BLUP_all.RData")
save(TP4_WDH20_BLUP_all, file="data/Winter_DH/TP4_WDH20_BLUP_all.RData")
save(TP5_WDH20_BLUP_all, file="data/Winter_DH/TP5_WDH20_BLUP_all.RData")

save(Field_WDH20_BLUP_all,file="data/Winter_DH/Field_WDH20_BLUP_all.Rdata")

```

BLUE extra
```{r}
#Extra code for extracting fixed effects
