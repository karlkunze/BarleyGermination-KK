...
df2$List
library(readxl)
#WMB21_Master_selections_top25 <- 
#needed to check WMB22 regional selected lines  
#read_excel("C:/Users/Karl/git/Cornell-WMB21-selections/data/WMB21_Master_selections_top25.xlsx")
getwd()
WMB21_Master_selections<-read_excel("2021_prep/WMB21_Master_selections_09202021.xlsx")
#read_excel("C:/Users/Karl/git/Cornell-WMB21-selections/data/WMB21_Master_selections_top25.xlsx")


#list1<-c(WMB21_Master_selections_top25$Entry)
list1<-c(WMB21_Master_selections$Entry)
table(df2$List)/4
#df2[df2$taxa%in%list1,]$List="WMB21"
df2$PM_date
#View(df2[df2$Pedigree=="Wintmalt"&df2$model=="BLUE"&df2$TP=="TP3",c(1,4)])
#need to remove this 
"BS812-50"
"BS712-70"
list1
...
q<-ggplot(data=df, aes(x=TP, y=value,group=taxa,color=List)) +
  ...
  scale_color_manual(values=c("#ADD8E6","gray","red","green"))+
 scale_fill_manual()+
