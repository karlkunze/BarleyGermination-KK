...
Sub20[Sub20$Pedigree=="Flavia"&Sub20$TP=="TP3",]$Order<-1:72
Sub20[Sub20$Pedigree=="Scala"&Sub20$TP=="TP3",]$Order<-1:nrow(Sub20[Sub20$Pedigree=="Scala"&Sub20$TP=="TP3",])

Sub20[Sub20$Pedigree=="SY Tepee"&Sub20$TP=="TP3",]$Order<-1:nrow(Sub20[Sub20$Pedigree=="SY Tepee"&Sub20$TP=="TP3",])
Sub20[Sub20$Pedigree=="Wintmalt"&Sub20$TP=="TP3",]$Order<-1:nrow(Sub20[Sub20$Pedigree=="Wintmalt"&Sub20$TP=="TP3",])

table(Sub20$Pedigree)
vecF<-as.character(c(1,3,5,7,9,31,33,35,37,39,63,65,67,70,71))
Sub20[Sub20$Pedigree=="Flavia"&Sub20$Order%in%vecF,]$List="Select"
Sub20
vecK<-as.character(c(1,3,5,7,9,47,49,50,51,53,91,93,95,98,99))
Sub20[Sub20$Pedigree=="Scala"&Sub20$Order%in%vecK,]$List="Select"
121/2
vecT<-as.character(c(1,3,5,7,9,56,58,60,62,64,113,115,117,120,121))
Sub20[Sub20$Pedigree=="SY Tepee"&Sub20$Order%in%vecT,]$List="Select"
90/2
vecW<-as.character(c(1,3,5,7,9,41,43,45,47,49,82,84,86,89,90))
